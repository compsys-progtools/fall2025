...
- what it [conceptually](#conceptually-a-commit-is-a-snapshot) represents
- its [role](#a-commits-role-is-central-to-git) in a larger system
- what its [parts](#parts-of-a-commit) are
...
We see a lot more folders here than we had commits.  This is because there are multiple types of {term}`objects` that all create entries in this {term}`object database`

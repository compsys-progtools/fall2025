...
1. Use git bisect to find the first bad commit in the [toy bug repo](https://github.com/compsys-progtools/toy_bug) **This link is not working 404 error** , save the command history and the bad commit hash to {index}`git_debug.md`
